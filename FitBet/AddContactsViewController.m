...
@interface AddContactsViewController () <THContactPickerDelegate, UITableViewDataSource, UITableViewDelegate>

@property (strong, nonatomic) THContactPickerView * contactPickerView;
...
- (void)viewDidLoad {
    ...
    [self.contactPickerView setPlaceholderLabelText:@"Add participants"];
...
- (void)contactPicker:(THContactPickerView *)contactPicker textFieldDidChange:(UITextField *)textField {
    if ([textField.text isEqualToString:@""]){
        ...
        for(NSString * name in self.contacts) {
            ...
            if([name containsString:textField.text]) {
                [tempArray addObject:name];
            }
        }
        self.filteredContacts = tempArray;
